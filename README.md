...
description is associated with each file along with its contents.  The *--verbose* will
...
The *--ltz* option results in the use of local time instead of UTC.  The *--verbose* will
display progress and informational messages generated by the utilities.
...
a factor of 2.  The *--verbose* will display progress and informational messages
...
*--verbose* will display progress and informational messages generated by the utilities.
